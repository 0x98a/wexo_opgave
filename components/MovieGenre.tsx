                ...
                <>
                    <div className="w-full flex flex-col xl:flex-row justify-center items-center gap-4">
                        {movies.slice(0, 6).map((movie: any, index: any) => (
                            <div key={`movie-${index}`} className="w-full xl:min-h-[20rem] min-h-[5rem] flex flex-col justify-center items-center rounded-md hover:scale-[103%] transition-all border-2 border-[#353535] bg-[#292929] hover:border-[#616161] hover:bg-[#3f3f3f]">
